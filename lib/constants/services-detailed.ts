    ...
    subcategories: [
      {
        ...
        services: [
          { id: "basic-grooming-dog", name: "Basic grooming (Dog)", duration: "60 min", priceRange: "฿600-1,200" },
          { id: "full-grooming-dog", name: "Full grooming (Dog)", duration: "120 min", priceRange: "฿1,200-2,500" },
          { id: "bath-blow-dry-dog", name: "Bath + blow dry (Dog)", duration: "60 min", priceRange: "฿500-1,000" },
          { id: "nail-ear-care-dog", name: "Nail trim & ear cleaning (Dog)", duration: "20 min", priceRange: "฿200-300" },
          { id: "basic-grooming-cat", name: "Basic grooming (Cat)", duration: "45 min", priceRange: "฿500-900" },
          { id: "full-grooming-cat", name: "Full grooming (Cat)", duration: "90 min", priceRange: "฿1,000-2,000" },
          { id: "bath-blow-dry-cat", name: "Bath + blow dry (Cat)", duration: "45 min", priceRange: "฿400-800" },
          { id: "nail-ear-care-cat", name: "Nail trim & ear cleaning (Cat)", duration: "15 min", priceRange: "฿150-250" },
        ],
      },
      {
        id: "walking",
